...
export default function CaseProfile() {
    ...
    const {
        ...
        inzForms = [], dependents = [], vif = null, caseOptions = [], tiedTo = null,
    } = props;
    ...
    const tabProps = {
        ...
        communications, agreements, notes, activity, findings, process, threads, caseStaff, financials, inzForms, dependents, vif, caseOptions,
    };
    ...
    return (
        <div className="max-w-[1300px] mx-auto pb-12 space-y-5">
            ...
            <CaseProfileHeader lead={lead} intake={intake} attention={attention} tiedTo={tiedTo} />
