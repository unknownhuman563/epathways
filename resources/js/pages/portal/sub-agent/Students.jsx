// Re-export of the Education Students screen — resolved under portal/sub-agent/ so
// app.jsx wraps it in SubAgentLayout. The controller scopes the rows to this
