...
export default function LeadJourney({ lead, roadmap = [], currentPhase = null, preEngagement = false, submissions = [] }) {
    return (
        <div className="space-y-8 max-w-4xl mx-auto pb-12">
            ...
            {preEngagement ? (
                <section className="bg-white border border-[#009688]/30 rounded-2xl p-8 text-center">
                    <p className="text-[10px] font-bold uppercase tracking-[0.32em] text-[#009688] mb-2">
                            ...
                            <li key={p.key} className="relative pl-12 pb-6 last:pb-0">
                                ...
                                <div
                                    className={`rounded-2xl border p-5 ${
                                        isCurrent
                                            ? 'bg-white border-[#009688] shadow-[0_24px_48px_-24px_rgba(67,98,53,0.35)]'
                                            : isDone
                                ...
                                >
                                    <div className="flex items-center justify-between gap-3 flex-wrap mb-1">
                                        <p className={`text-[10px] font-bold uppercase tracking-[0.22em] ${isCurrent ? 'text-[#009688]' : 'text-[#282728]/40'}`}>
                                            {p.department || 'Outcome'}
                                        </p>
                                        <span className={`text-[9px] font-bold uppercase tracking-[0.22em] ${
                                            isCurrent ? 'text-[#009688]' : isDone ? 'text-[#009688]/70' : 'text-[#282728]/30'
                                        }`}>
            ...
            {submissions.length > 0 && (
                <section className="bg-white rounded-2xl border border-[#282728]/15 overflow-hidden">
                    <div className="px-6 py-4 border-b border-[#282728]/10">
                        <p className="text-[10px] font-bold uppercase tracking-[0.32em] text-[#009688] mb-1">Past submissions</p>
