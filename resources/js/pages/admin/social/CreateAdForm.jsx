...
import { Megaphone, Loader2, Sparkles, ImagePlus } from 'lucide-react';
...
export default function CreateAdForm() {
    ...
    const [targeting, setTargeting] = useState(blankTargeting);
    ...
    return (
        <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <div className="flex items-center gap-2 mb-1">
                ...
                <h3 className="text-sm font-bold text-gray-900">Create Ad</h3>
            </div>
            <p className="text-xs text-gray-400 mb-5">Design the creative and configure targeting — launches a paid ad on the selected account.</p>
