...
// The shared industry data references images by string key ("education",
// "visa", "settlement", "agents") so the data file doesn't depend on the
// asset resolver. We resolve those keys to actual image modules here.
const IMAGE_MAP = {
    education:  educationImg,
    visa:       visaImg,
    settlement: settlementImg,
    agents:     agentsImg,
};

const categories = INDUSTRY_CATEGORIES.map((c) => ({
    ...c,
    image: IMAGE_MAP[c.image] || educationImg,
}));
