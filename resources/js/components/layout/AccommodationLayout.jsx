...
import {
    ...
    CalendarDays, ClipboardList, Flame, MessageSquare, MessageSquareWarning, BarChart3, User, Bell,
} from "lucide-react";
...
const ACCOMMODATION_NAV = [
    ...
    { name: "Complaints", href: "/portal/accommodation/complaints", icon: <MessageSquareWarning size={20} /> },
