...
class DefaultMessageTemplatesSeeder extends Seeder
{
    public function run(): void
    {
        $standardVars = [
            ...
            ['name' => 'assigned_staff_name', 'description' => 'Assigned staff member, or "the Luvep team"'],
        ];
        ...
        $templates = [
            ...
            [
                ...
                'channels' => ['email', 'sms'],
                'email_subject' => 'Luvep needs your {{document_name}}',
                ...
                'sms_body' => 'Luvep needs your {{document_name}}. Upload it here (no login): {{tracker_url}}',
            ...
            [
                ...
                'channels' => ['email', 'sms'],
                'email_subject' => 'Your Luvep document was approved',
                ...
                'sms_body' => 'Good news {{first_name}} — your Luvep document "{{document_name}}" was approved.',
            ...
            [
                ...
                'channels' => ['email', 'sms'],
                'email_subject' => 'Your Luvep document needs attention',
                ...
                'sms_body' => 'Your Luvep document "{{document_name}}" needs attention. {{reason}} Re-upload: {{tracker_url}}',
            ...
            [
                ...
                'channels' => ['email'],
                'email_subject' => 'Your Luvep portal access is ready',
                'email_body' => "# Welcome to your Luvep portal, {{first_name}}\n\nWe've set up secure portal access for you. The activation link is sent separately for security.\n\nNgā mihi,\nThe Luvep team",
                'variables_documented' => $standardVars,
            ],
        ];
        ...
        foreach (MessageTemplate::DEPARTMENTS as $department) {
            ...
            MessageTemplate::updateOrCreate(
                ...
                [
                    ...
                    'channels' => ['email'],
                    'email_subject' => 'An update on your Luvep application',
                    ...
                    'sms_body' => 'Hi {{first_name}}, an update on your Luvep application — status: {{status}}. Details: {{tracker_url}}',
