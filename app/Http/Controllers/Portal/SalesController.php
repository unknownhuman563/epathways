...
class SalesController extends Controller
{
    ...
    {
        if (in_array($stage, ['New Leads', 'Contact Attempted', 'Contacted for Booking', 'Booking Confirmation with Bryll', 'Missed the Meeting'], true)) return 'Early';
        if (in_array($stage, ['Qualified but Not Ready', 'Qualified but No Funds', 'Qualified', 'Booked Consultation', 'Did Not Book Consultation', 'No Show', 'Consultation Done'], true)) return 'Nurture';
        if (in_array($stage, ['Proposal Sent', 'Consultancy Agreement', 'English Pro', 'School Enrollment', 'Visa Process'], true)) return 'Qualified';
        return 'Closed';
    }
    ...
    public function bulkEmail()     { return inertia('portal/sales/BulkEmail',     ['portal' => 'sales']); }
